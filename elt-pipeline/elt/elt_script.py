...
def wait_for_dependencies(host, max_retries=5, delay_seconds=5):
...
# Our ELT process will only run if our dependent service has already started
if not wait_for_dependencies(host="source_postgres"):
    exit(1)
...
# To get everything from source database to destination...
